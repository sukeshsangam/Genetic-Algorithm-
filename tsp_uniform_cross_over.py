...
def perform_crossover(list_for_crossover,a,b):
	...
	for i in range(len(list_for_crossover[a])):
		r=random.uniform(0,1)
		if r>0.5:
			
			temp=list_for_crossover[a][i]
			if list_for_crossover[b][i] not in list_for_crossover[a]:
				if list_for_crossover[a][i] not in list_for_crossover[b]:
					list_for_crossover[a][i]=list_for_crossover[b][i]
					list_for_crossover[b][i]=temp
	return_list=list_for_crossover[:]
	return return_list
...
while(1):
	...
	for i in range(0,iter):
		...
		child=perform_crossover(list_for_crossover_1,a,b)
		#child_two=perform_crossover(list_for_crossover_2,b,a)
		initial_set=deepcopy(child)
